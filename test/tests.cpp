...
TEMPLATE_TEST_CASE("basic functionality checks", HEADER_OR_MODULE_TAG, c<1>, c<2>, c<3>, c<4>, c<5>) {
    ...
    CHECK_MATRIX(crc::crc3_gsm::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x4);
    CHECK_MATRIX(crc::crc3_rohc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x6);
    CHECK_MATRIX(crc::crc4_g_704::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x7);
    CHECK_MATRIX(crc::crc4_interlaken::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xB);
    CHECK_MATRIX(crc::crc5_epc_c1g2::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x00);
    CHECK_MATRIX(crc::crc5_g_704::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x07);
    CHECK_MATRIX(crc::crc5_usb::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x19);
    CHECK_MATRIX(crc::crc6_cdma2000_a::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x0D);
    CHECK_MATRIX(crc::crc6_cdma2000_b::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x3B);
    CHECK_MATRIX(crc::crc6_darc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x26);
    CHECK_MATRIX(crc::crc6_g_704::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x06);
    CHECK_MATRIX(crc::crc6_gsm::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x13);
    CHECK_MATRIX(crc::crc7_mmc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x75);
    CHECK_MATRIX(crc::crc7_rohc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x53);
    CHECK_MATRIX(crc::crc7_umts::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x61);
    CHECK_MATRIX(crc::crc8_autosar::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xDF);
    CHECK_MATRIX(crc::crc8_bluetooth::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x26);
    CHECK_MATRIX(crc::crc8_cdma2000::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xDA);
    CHECK_MATRIX(crc::crc8_darc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x15);
    CHECK_MATRIX(crc::crc8_dvb_s2::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xBC);
    CHECK_MATRIX(crc::crc8_gsm_a::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x37);
    CHECK_MATRIX(crc::crc8_gsm_b::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x94);
    CHECK_MATRIX(crc::crc8_hitag::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xB4);
    CHECK_MATRIX(crc::crc8_i_432_1::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xA1);
    CHECK_MATRIX(crc::crc8_i_code::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x7E);
    CHECK_MATRIX(crc::crc8_lte::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xEA);
    CHECK_MATRIX(crc::crc8_maxim_dow::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xA1);
    CHECK_MATRIX(crc::crc8_mifare_mad::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x99);
    CHECK_MATRIX(crc::crc8_nrsc_5::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xF7);
    CHECK_MATRIX(crc::crc8_opensafety::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x3E);
    CHECK_MATRIX(crc::crc8_rohc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xD0);
    CHECK_MATRIX(crc::crc8_sae_j1850::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x4B);
    CHECK_MATRIX(crc::crc8_smbus::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xF4);
    CHECK_MATRIX(crc::crc8_tech_3250::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x97);
    CHECK_MATRIX(crc::crc8_wcdma::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x25);
    CHECK_MATRIX(crc::crc10_atm::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x199);
    CHECK_MATRIX(crc::crc10_cdma2000::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x233);
    CHECK_MATRIX(crc::crc10_gsm::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x12A);
    CHECK_MATRIX(crc::crc11_flexray::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x5A3);
    CHECK_MATRIX(crc::crc11_umts::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x061);
    CHECK_MATRIX(crc::crc12_cdma2000::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xD4D);
    CHECK_MATRIX(crc::crc12_dect::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xF5B);
    CHECK_MATRIX(crc::crc12_gsm::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xB34);
    CHECK_MATRIX(crc::crc12_umts::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xDAF);
    CHECK_MATRIX(crc::crc13_bbc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x04FA);
    CHECK_MATRIX(crc::crc14_darc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x082D);
    CHECK_MATRIX(crc::crc14_gsm::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x30AE);
    CHECK_MATRIX(crc::crc15_can::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x059E);
    CHECK_MATRIX(crc::crc15_mpt1327::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x2566);
    CHECK_MATRIX(crc::crc16_arc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xBB3D);
    CHECK_MATRIX(crc::crc16_cdma2000::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x4C06);
    CHECK_MATRIX(crc::crc16_cms::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xAEE7);
    CHECK_MATRIX(crc::crc16_dds_110::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x9ECF);
    CHECK_MATRIX(crc::crc16_dect_r::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x007E);
    CHECK_MATRIX(crc::crc16_dect_x::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x007F);
    CHECK_MATRIX(crc::crc16_dnp::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xEA82);
    CHECK_MATRIX(crc::crc16_en_13757::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xC2B7);
    CHECK_MATRIX(crc::crc16_genibus::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xD64E);
    CHECK_MATRIX(crc::crc16_gsm::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xCE3C);
    CHECK_MATRIX(crc::crc16_ibm_3740::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x29B1);
    CHECK_MATRIX(crc::crc16_ibm_sdlc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x906E);
    CHECK_MATRIX(crc::crc16_iso_iec_14443_3_a::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xBF05);
    CHECK_MATRIX(crc::crc16_kermit::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x2189);
    CHECK_MATRIX(crc::crc16_lj1200::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xBDF4);
    CHECK_MATRIX(crc::crc16_m17::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x772B);
    CHECK_MATRIX(crc::crc16_maxim_dow::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x44C2);
    CHECK_MATRIX(crc::crc16_mcrf4xx::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x6F91);
    CHECK_MATRIX(crc::crc16_modbus::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x4B37);
    CHECK_MATRIX(crc::crc16_nrsc_5::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xA066);
    CHECK_MATRIX(crc::crc16_opensafety_a::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x5D38);
    CHECK_MATRIX(crc::crc16_opensafety_b::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x20FE);
    CHECK_MATRIX(crc::crc16_profibus::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xA819);
    CHECK_MATRIX(crc::crc16_riello::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x63D0);
    CHECK_MATRIX(crc::crc16_spi_fujitsu::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xE5CC);
    CHECK_MATRIX(crc::crc16_t10_dif::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xD0DB);
    CHECK_MATRIX(crc::crc16_teledisk::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x0FB3);
    CHECK_MATRIX(crc::crc16_tms37157::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x26B1);
    CHECK_MATRIX(crc::crc16_umts::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xFEE8);
    CHECK_MATRIX(crc::crc16_usb::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xB4C8);
    CHECK_MATRIX(crc::crc16_xmodem::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x31C3);
    CHECK_MATRIX(crc::crc17_can_fd::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x04F03);
    CHECK_MATRIX(crc::crc21_can_fd::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x0ED841);
    CHECK_MATRIX(crc::crc24_ble::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xC25A56);
    CHECK_MATRIX(crc::crc24_flexray_a::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x7979BD);
    CHECK_MATRIX(crc::crc24_flexray_b::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x1F23B8);
    CHECK_MATRIX(crc::crc24_interlaken::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xB4F3E6);
    CHECK_MATRIX(crc::crc24_lte_a::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xCDE703);
    CHECK_MATRIX(crc::crc24_lte_b::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x23EF52);
    CHECK_MATRIX(crc::crc24_openpgp::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x21CF02);
    CHECK_MATRIX(crc::crc24_os_9::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x200FA5);
    CHECK_MATRIX(crc::crc30_cdma::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x04C34ABF);
    CHECK_MATRIX(crc::crc31_philips::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x0CE9E46C);
    CHECK_MATRIX(crc::crc32_aixm::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x3010BF7F);
    CHECK_MATRIX(crc::crc32_autosar::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x1697D06A);
    CHECK_MATRIX(crc::crc32_base91_d::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x87315576);
    CHECK_MATRIX(crc::crc32::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xFC891918);
    CHECK_MATRIX(crc::crc32_cd_rom_edc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x6EC2EDC4);
    CHECK_MATRIX(crc::crc32_cksum::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x765E7680);
    CHECK_MATRIX(crc::crc32c::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xE3069283);
    CHECK_MATRIX(crc::crc32_iso_hdlc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xCBF43926);
    CHECK_MATRIX(crc::crc32_jamcrc::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x340BC6D9);
    CHECK_MATRIX(crc::crc32_mef::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xD2C22F51);
    CHECK_MATRIX(crc::crc32_mpeg2::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x0376E6E7);
    CHECK_MATRIX(crc::crc32_xfer::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xBD0BE338);
    CHECK_MATRIX(crc::crc40_gsm::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xD4164FC646);
    CHECK_MATRIX(crc::crc64_ecma_182::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x6C40DF5F0B497347);
    CHECK_MATRIX(crc::crc64_go_iso::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xB90956C775A41001);
    CHECK_MATRIX(crc::crc64_ms::compute(crc::slice_by<N>, test_data_noncontiguous) == 0x75D4B74F024ECEEA);
    CHECK_MATRIX(crc::crc64_nvme::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xAE8B14860A799888);
    CHECK_MATRIX(crc::crc64_redis::compute(crc::slice_by<N>, test_data_noncontiguous) == 0xE9C6D914C4B8D9CA);
